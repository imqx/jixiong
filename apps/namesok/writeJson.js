...
var data = [
  ...
  '天赋吉运，能得人望，善用智慧，必获成功。（吉）+官+艺',
  '忍得若难，必有后福，是成是败，惟靠紧毅。（凶）+艺',
  '谦恭做事，外得人和，大事成就，一门兴隆。（吉）+财',
  '能获众望，成就大业，名利双收，盟主四方。（吉）+财+官',
  '排除万难，有贵人助，把握时机，可得成功。（吉）',
  '经商做事，顺利昌隆，如能慎始，百事亨通。（吉）+艺',
  '成功虽早，慎防亏空，内外不合，障碍重重。（凶）',
  '智商志大，历尽艰难，焦心忧劳，进得两难。（凶）',
  '先历困苦，后得幸福，霜雪梅花，春来怒放。（吉）+官',
  '秋草逢霜，怀才不遇，忧愁怨苦，事不如意。（凶）',
  '旭日升天，名显四方，渐次进展，终成大业。（吉）+官',
  '绵绣前程，须靠自力，多用智谋，能奏大功。（吉）+财',
  '天时地利，只欠人和，讲信修睦，即可成功。（吉）',
  '波澜起伏，千变万化，凌架万难，必可成功。（凶带吉）+艺',
  '一成一败，一盛一衰，惟靠谨慎，可守成功。（吉带凶）',
  '鱼临旱地，难逃恶运，此数大凶，不如更名。（凶）',
  '如龙得云，青云直上，智谋奋进，才略奏功。（吉）+财+官+艺',
  '吉凶参半，得失相伴，投机取巧，吉凶无常。（吉带凶）',
  '此数大吉，名利双收，渐进向上，大业成就。（吉）+官',
  '池中之龙，风云际会，一跃上天，成功可望。（吉）+财',
  '意气用事，人和必失，如能慎始，必可昌隆。（吉）+财+艺',
  '灾难不绝，难望成功，此数大凶，不如更名。（凶）',
  '中吉之数，进退保守，生意安稳，成就普通。（吉）+艺',
  '波澜得叠，常陷穷困，动不如静，有才无命。（凶）',
  '逢凶化吉，吉人天相，风调雨顺，生意兴隆。（吉）+官',
  '名虽可得，利则难获，艺界发展，可望成功。（凶带吉）+艺',
  '云开见月，虽有劳碌，光明坦途，指日可望。（吉）+官',
  '一成一衰，沉浮不定，知难而退，自获天佑。（吉带凶）',
  '天赋吉运，德望兼备，继续努力，前途无限。（吉）+财+官',
  '事业不专，十九不成，专心进取，可望成功。（吉带凶）',
  '雨夜之花，外祥内苦，忍耐自重，转凶为吉。（吉带凶）',
  '虽用心计，事难遂愿，贪功冒进，必招失败。（凶）',
  '杨柳遇春，绿叶发枝，冲破难关，一举成名。（吉）+官',
  '坎坷不平，艰难重重，若无耐心，难望有成。（凶）',
  '有贵人助，可成大业，虽遇不幸，浮沉不定。（吉）+官',
  '美化丰实，鹤立鸡群，名利俱全，繁荣富贵。（吉）+艺',
  '遇吉则吉，遇凶则凶，惟靠谨慎，逢凶化吉。（凶）',
  '吉凶互见，一成一败，凶中有吉，吉中有凶。（吉带凶）',
  '一盛一衰，浮沉不常，自重自处，可保平安。（吉带凶）',
  '草木逢春，雨过天晴，渡过难关，即获成功。（吉）+财',
...
for (let v of data) {
  ...
  dataJson.push({
    ...
    jx: v.substring(20, v.indexOf('）') + 1),
    guan: sps[1].includes('官'),
    cai: sps[1].includes('财'),
    yi: sps[1].includes('艺'),
  });
  i++;
}
...
fs.writeFileSync(
  './apps/namesok/data.json',
  JSON.stringify({ desert: dataJson })
);
